...
public class T3_Actions_Hover {
        ...
        // OUR GOAL IS LEARNING some "ACTIONS" of mouse FROM "ACTIONS" CLASS OF SELENIUM LIBRARY.
    // Actions class is used to handle "advanced" mouse and keyboard actions. (context click: right click)
