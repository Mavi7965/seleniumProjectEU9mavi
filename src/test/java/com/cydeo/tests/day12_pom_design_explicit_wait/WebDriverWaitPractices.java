...
public class WebDriverWaitPractices {
    ...
    public void dynamic_load_1_test(){
        ...
        wait.until(ExpectedConditions.visibilityOf(dynamicLoad1Page.inputPassword));



        //7. click to submit button

        wait.until(ExpectedConditions.elementToBeClickable(dynamicLoad1Page.submitButton));
...
// I ADDED EXTRA  EXPLICIT WAIT METHOD FROM SELENIUM AMONG THE LINES
